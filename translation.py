...
"""
    ...
    BANNED_USER_TEXT = "Sorry!! But Mai Owner As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Join : @Jimi_Bots For more Details.. " 
    DOWNLOAD_START = "<b>Yupp!Downloading To My server !! Plz Wait</b>"
    UPLOAD_START = "<i>Downloading Completed Now I'm Sending Wait..</i>"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "<b>Thank you for Using Me Support Our Channel @Jimi_Bots ❤️</b>"
