    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/Jimi_Bots'),
                    InlineKeyboardButton('Feedback', url='https://t.me/jimibots_grp')
                ],
                [
                    InlineKeyboardButton('More Bots', url='https://t.me/Jimi_Bots/25'),
